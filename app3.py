...
tk_title = "Instalocker" # Put here your window title

root=Tk() # root (your app doesn't go in root, it goes in window)
root.title(tk_title) 
root.overrideredirect(True) # turns off title bar, geometry
root.geometry('1080x720+300+300') # set new geometry the + 75 + 75 is where it starts on the screen
...
close_button = Button(title_bar, text='  ×  ', command=root.destroy,bg=RGRAY,padx=2,pady=2,font=("calibri", 12),bd=0,fg='white',highlightthickness=0)
expand_button = Button(title_bar, text=' 🗖 ', command=maximize_me,bg=RGRAY,padx=2,pady=2,bd=0,fg='white',font=("calibri", 12),highlightthickness=0)
minimize_button = Button(title_bar, text=' ― ',command=minimize_me,bg=RGRAY,padx=2,pady=2,bd=0,fg='white',font=("calibri", 12),highlightthickness=0)
...
canvas.pack(side=LEFT, fill=BOTH, expand=True, padx=(15,25), pady = 20)
...
def click(i):
    print(f"Clicked on image {name[i]}")
image_folder = "images"
images = []
name = []
